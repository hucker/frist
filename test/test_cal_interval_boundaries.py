...
def test_minute_interval_half_open():
    ...
    # Assert
    assert in_current is False, (
        "Value at end of minute should not be in current interval"
    )
...
def test_quarter_interval_half_open():
    ...
    # Assert
    assert in_current is False, (
        "Value at end of quarter should not be in current interval"
    )
...
def test_year_interval_half_open():
    ...
    # Assert
    assert in_current is False, (
        "Value at start of next year should not be in current interval"
    )
